...
const DEFAULT_EMAIL_FROM = '"Best from Integer Training LMS" <notify@mail.classroomio.com>';
const DEFAULT_EMAIL_REPLY_TO = '"Best from Integer Training LMS" <help@classroomio.com>';
